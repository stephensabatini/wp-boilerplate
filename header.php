...
<html <?php language_attributes(); ?> class="no-js no-svg" itemscope="" itemtype="https://schema.org/WebPage">
    <head>
        ...
        <meta name="msapplication-config" content="<?php echo BOILERPLATE_TEMPLATE_URL; ?>/browserconfig.xml" />
        <link rel="manifest" href="<?php echo BOILERPLATE_TEMPLATE_URL; ?>/manifest.json" />
        <link rel="author" href="<?php echo BOILERPLATE_TEMPLATE_URL; ?>/humans.txt" />
