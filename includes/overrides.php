...
function setup() {
	 ...
	 */
	add_filter( 'excerpt_more', $n( 'edit_excerpt_more' ) );
}
...
/**
 * Removes ver URI parameters from all assets as a security precaution.
 *
...
/**
 * Adds 64x64 image to the site icons generated by the theme customizer.
 *
 * @param array $sizes Array of integers defining the site icon image sizes.
 */
...
/**
 * Adds 64x64 and 512x512 image to the site icons generated by the theme customizer.
 *
 * @param array $meta_tags Array of integers defining the site icon image sizes.
 */
